function dataRankingTest(){
  ...
  */
  ...
  first.innerHTML = "<p>1位は" + finalRank[0].name + "、スコアは" + finalRank[0].Score + "</p>";
  second.innerHTML = "<p>2位は" + finalRank[1].name + "、スコアは" + finalRank[1].Score + "</p>";
  third.innerHTML = "<p>3位は" + finalRank[2].name + "、スコアは" + finalRank[2].Score + "</p>";
